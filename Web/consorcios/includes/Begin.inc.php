...
<title><?php echo $Cfg['SiteName']; ?> - <?php echo $Page->Title; ?></title>

<META name="title" content="<?php echo $Page->Title ?>">
<META name="description" content="<?php echo $Cfg['SiteDescription'] ?>">
...
<link rel="stylesheet" href="<?php echo $Page->Prefix; ?>styles/style.css">
<link rel="stylesheet" href="<?php echo $Page->Prefix; ?>css/bootstrap.css">
<link rel="stylesheet" href="<?php echo $Page->Prefix; ?>css/docs.css">
<link rel="stylesheet" href="<?php echo $Page->Prefix; ?>styles/styleex.css">
<?php
	if ($Page->FileJs)
